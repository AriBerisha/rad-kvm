...
# established timings (0x23-0x25): 640x480@60 + 800x600@60 + 1024x768@60
ESTABLISHED = bytes([0x21, 0x08, 0x00])
...
dbc = vdb + hdmi
cea_dtds = dtd_1080p30 + dtd_1024x600 + dtd_800x480   # extra detailed timings
ndtd = 3
...
print("modes: 640x480 800x480 800x600 1024x600 1024x768 1280x720(pref) 1080p30 +720p50/1080p25")
